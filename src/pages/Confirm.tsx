  ...
  return (
    <>
      <main className="grid grid-cols-2 lg:grid-cols-1 lg:grid-rows-2 relative">
        <Container styles="bg-slate-900 lg:row-start-2 ">
          <Link
            to={"./generate"}
        ...
        <Container styles="font-outfit lg:row-start-1">
          <div>
            <h1 className="text-center text-4xl font-bold my-8">
              Confirm your input data
            </h1>
            <section className="grid grid-cols-2 grid-rows-2 gap-4 max-w-xl h-96 lg:h-full lg:mb-10">
